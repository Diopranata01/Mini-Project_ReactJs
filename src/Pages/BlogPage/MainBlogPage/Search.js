...
import { IniNavbar, Loading } from "../../../Component";
          ...
          <div className="row justify-content-center py-3 row-cols-md-4">
            <div className="col-md-3 ms-5" style={{ paddingLeft: "70px" }}>
              <Nav variant="tabs" defaultActiveKey="/">
                <Nav.Item>
                  <Nav.Link href="/" style={{ color: '#000' }}>Post</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  {/* <Nav.Link eventKey="link-1" as={} to={{ pathname: '/home', data:{ someData: true }}} style={{ color: '#000' }}>Created</Nav.Link> */}
                  <Nav.Link eventKey="link-1" as={Link} to={{ pathname: '/home', newData:{ data: data.user_post }}} style={{ color: '#000' }}>Created</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="link-2" style={{ color: '#000' }}>Deleted</Nav.Link>
                </Nav.Item>
              </Nav>
            </div>
