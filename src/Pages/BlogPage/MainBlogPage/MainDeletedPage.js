...
import { UnPosts } from "./UnPosts/UnPosts";
import { BLOG_POSTS, GET_BLOG_POSTS_BY, GET_DELETED_BLOG_POSTS_BY } from "../../../Database/queries";
...
export const MainDeletedPage = () => {
  // search by id (masih ada bug karna search by overall id)
  const [search, { loading, error, data }] = useLazyQuery(GET_DELETED_BLOG_POSTS_BY);
